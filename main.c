...
void menu(void)
{
  ...
  do{
    ...
    printf("=================================================\n");
    printf("||4.Information and tips about periodic table .||\n");
    printf("=================================================\n");
    printf("||5. Exit .                                    ||\n");
    printf("=================================================\n\n");
...
void displayTable(void)
{
    ...
    char op;
        ...
        do
        {
            printf("Enter '1' to search or '0' to go back to menu :");
            printf("\n\n\n Enter '5' to EXIT:");
            fflush(stdin);
            scanf("%c",&op);
       ...
       for(i=1;i<=118;i++)
                      {
                         ...
                         break; }
                         else   {printf("SORRY! Could not found!\nPlease,check your spelling.\n");break;}
                      }
        ...
        for(i=1;i<=118;i++)
                      {
                         ...
                         else   {printf("SORRY! Could not found!\nPlease,enter correct atomic number.\n");break;}
                      }
            printf("Enter 0 to go back to menu or press any key to search again : ");
            fflush(stdin);
            scanf("%c",&op);
